...
scenarios = [
    ...
    {"attack_id": "MULE_001", "category": AttackCategory.MULE_NETWORK, "channel": "P2P", "risk_level": RiskLevel.CRITICAL, "description": "Multiple senders to hub account + fast onward movement", "parameters": {"velocity_multiplier": 6, "time_window_minutes": 30}},
